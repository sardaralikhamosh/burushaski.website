...
$basedir = '/home/he/hej/hejleh.com/public/www/';
$baseurl = 'http://www.hejleh.com/';
@files = ('*.html','tree/*.html');
$title = "Abu Hejleh Family Tree";
$title_url = 'http://www.hejleh.com/';
$search_url = 'http://www.hejleh.com/index.html';
...
sub return_html {
   ...
   print "Below are the results of your Search in no particular order:<p><hr><p>\n";
   print "<ul>\n";
   ...
   print "</ul><br><hr><P>\n";
   print "<ul>\n<li><a href=\"$search_url\">Back to Abu Hejleh Family Tree Index</a>\n";
   print "<li><a href=\"$title_url\">$title</a>\n";
   print "</ul>\n";
   print "<hr>\n";
   print "<center><FONT Size=-1>Search Script written by Matt Wright and can be found at <a href=\"http://www.worldwidemart.com/scripts/\">Matt's Script Archive</a></font></center>\n";
   print "</body>\n</html>\n";
}
